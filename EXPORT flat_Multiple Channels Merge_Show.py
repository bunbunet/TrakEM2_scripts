...
LeaveDisp=False
# SEE ALL THE DISPLAYABELS: SET TRUE to unhide all the displayables
...
# to define the parameters of the merge channel command
# we use a for loop and a string concatenation
