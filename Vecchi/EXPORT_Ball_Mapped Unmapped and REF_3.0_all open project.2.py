...
Output_DIR="C:\\Users\\Federico Luzzati\\Desktop\\txt\\" # MUST have ending slash
...
for project in projects:
	...
	rows2= []
	rows3= []
 	txt1_path = os.path.join(Output_DIR, specimen+"_"+"mapped"+".txt")
 	txt2_path = os.path.join(Output_DIR, specimen+"_"+"unmapped"+".txt")
 	txt3_path = os.path.join(Output_DIR, specimen+"_"+"REF"+".txt")
